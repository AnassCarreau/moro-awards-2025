...
import { Category, NominationMode } from '@/types/database'
...
export function NominationForm({ category, onSuccess, onLoginRequired }: NominationFormProps) {
  const { user } = useAuth()
    ...
    switch (category.mode) {
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, nominated_user: e.target.value })}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-300">¿El tweet ha sido borrado?</span>
              </div>
              <button
                type="button"
            ...
            {!isDeletedContent ? (
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, nominated_link: e.target.value })}
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2 text-sm font-medium text-gray-300">
                  <FileText size={16} />
                  Describe el contenido borrado
                </label>
                <textarea
                  value={formData.nominated_text}
                  onChange={(e) => setFormData({ ...formData, nominated_text: e.target.value })}
      ...
      case 'link_or_text':
        return (
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10">
              <span className="text-sm text-gray-300">¿El contenido ha sido borrado?</span>
              <button
                type="button"
                onClick={() => setIsDeletedContent(!isDeletedContent)}
                className={`relative w-12 h-6 rounded-full transition-colors ${
      ...
      case 'proposal':
        return (
          <div className="space-y-2">
            <label className="flex items-center gap-2 text-sm font-medium text-gray-300">
              <FileText size={16} />
              Propón un título para el premio
            </label>
            <input
              type="text"
