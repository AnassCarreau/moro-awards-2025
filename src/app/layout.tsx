...
import { PhaseProvider } from '@/components/providers/phase-provider'
...
export const metadata: Metadata = {
  ...
  description: 'Los premios de la comunidad de Twitter/X',
  icons: {
    icon: '/favicon.ico',
  },
}
...
function SupportButton() {
  return (
    <a
      href="https://discord.gg/MT9yCHjZyD"
      target="_blank"
      rel="noopener noreferrer"
      className="fixed top-6 right-6 flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 text-white p-4 rounded-full shadow-lg transition-all hover:scale-110 z-50"
